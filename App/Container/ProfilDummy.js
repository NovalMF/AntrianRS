...
class ProfilDummy extends Component {
    constructor(props) {
        super(props);
        this.state = {
            detailUser: [],
                    ...
                    <View style={{ marginTop: 20 }}>
                        ...
                        <View style={{ alignItems: 'center', justifyContent: 'space-between', flexDirection: 'row' }}>
                                <TouchableOpacity style={{ marginTop: 15, margin: 5, backgroundColor: 'white', height: 60, flexDirection: 'row', borderRadius: 50, marginBottom: 18, justifyContent: 'space-between', elevation: 5, borderWidth: 1, borderColor: 'white', paddingHorizontal: 10 }} onPress={() => this.props.navigation.navigate('TambahKeluarga')} >
                                    <Image source={Images.iconAccount} style={{ width: 55, height:55, color: '#0079eb', alignSelf: 'center' }}></Image>
                                    <Text style={{ fontFamily: Fonts.type.regular, fontSize: 16, alignSelf: 'center', top: -10 }}>Eka Lestati</Text>
                                    <Text style={{ fontFamily: Fonts.type.regular, fontSize: 16, alignSelf: 'center', top:10, right: 63, color:'#848484' }}>Istri</Text>
                                </TouchableOpacity>
                            </View>
                            <View style={{ alignItems: 'center', justifyContent: 'space-between', flexDirection: 'row' }}>
                                <TouchableOpacity style={{ marginTop: 15, margin: 5, backgroundColor: 'white', height: 60, flexDirection: 'row', borderRadius: 50, marginBottom: 18, justifyContent: 'space-between', elevation: 5, borderWidth: 1, borderColor: 'white', paddingHorizontal: 10 }} onPress={() => this.props.navigation.navigate('TambahKeluarga')} >
